...
| `/docs` | Lender integration guide (Solidity, `@humanline/sdk`, `cast`), the Attestcoin integration write-up, the security model, and the known limitations. |
...
| `/api` | Human-readable API reference generated from the OpenAPI document, with the [`@humanline/sdk`](https://www.npmjs.com/package/@humanline/sdk) install command for TypeScript callers. |
