...
_Collected 2026-09-13T08:46:04.695Z from CC3 testnet (chainId 102031) at block 5,479,827; block gas limit 75,000,000._
...
|---:|---:|---:|---:|---:|
| 1 | 19 | 237,972 | 276,948 | 279,188 |
| 2 | 6 | 496,720 | 520,016 | 633,808 |
| 3 | 2 | 773,365 | 773,365 | 791,161 |
| 4 | 1 | 741,470 | 741,470 | 741,470 |

- Live fit on batch size alone: gas ≈ 74,291 + 212,867 · updates (R² 0.913, 28 points).
- Live fit with the continuity span: gas ≈ 162,663 + 108,666 · updates + 439.9 · continuity roots (R² 0.996, 28 points).
...
Seconds from a World ID update's source block to its root landing on Creditcoin, per root, over 23.4 hours of relay history.

| Relay | Roots | Min | Median | p90 | Max |
|---|---:|---:|---:|---:|---:|
| both | 49 | 13.8 min | 26.4 min | 2.39 h | 2.78 h |
| sepolia | 28 | 13.9 min | 26.4 min | 2.04 h | 2.72 h |
...
|---|---:|---:|---:|---:|---:|
| relay calldata (bytes) | 36 | 3,684 | 6,532 | 31,268 | 39,876 |
| encoded source tx (bytes) | 42 | 2,400 | 5,216 | 5,216 | 5,216 |
| continuity roots per proof | 29 | 2 | 7 | 573 | 671 |
...
Every `0x0FD2` log in CC3 blocks 5,474,068–5,479,827 (24.0 h): 8,306 logs in 4,935 transactions to 72 distinct contracts. Humanline sent 36 of them (0.73%).

| Called contract | Transactions | Share | Humanline |
|---|---:|---:|---|
| `0x0c019e…230e` | 2,035 | 41.24% |  |
| `0x2d8a4d…c118` | 1,259 | 25.51% |  |
| `0xf7283a…36c5` | 625 | 12.66% |  |
| `0xb462c2…4d4c` | 343 | 6.95% |  |
| `0x4bc16e…e2ab` | 114 | 2.31% |  |
| `0xa97242…6047` | 81 | 1.64% |  |
| `0x1fc6c2…fdc9` | 75 | 1.52% |  |
| `0xa15564…5817` | 48 | 0.97% |  |
| `0x2af320…121c` | 36 | 0.73% |  |
| `0x0d5c85…22fc` | 36 | 0.73% |  |
| `0x666aec…6d39` | 24 | 0.49% |  |
| `0x3a7c3c…cef7` | 19 | 0.39% | yes |
